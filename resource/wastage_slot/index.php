...
<body class="loading" data-layout-config='{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": true}'>
    ...
    <div class="wrapper">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <label for="delivery" class="form-label">Delivery Person</label>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                                    <button onclick="bookSlot()" type="button" class="btn btn-primary" data-bs-dismiss="modal">Book Slot</button>
                                </div>
                            </div><!-- /.modal-content -->
                        </div><!-- /.modal-dialog -->
                    </div>
        ...
        <script>
            ...
            function viewSlot(hospital, city, id) {

                $('#name').val(hospital)
                $('#city').val(city)
                Wid = id;
                $('#slot-book').modal('show')
            }
            ...
            function bookSlot() {
                ...
                $.ajax({
                    url: '../../api/wastageSlot/allotSlot.php',
                    method: 'post',
                    data: {
                        Wid,
                        delivery,
                    ...
                    success: function(result) {
                        ...
                        if (result.success) {
                            ...
                            data.forEach(element => {
                                ...
                                let slot = '';
                                let button = `
                                    <button type="button" onClick="viewSlot('${element.name}','${element.city}',${element.id})" class="btn btn-primary btn-rounded btn-sm" >Allot Slot</button>
                                    `;
                                ...
                                if (element.status == '1' || element.status == '2' || element.status == '4') {
